...
def apply_initial_cut(icrs_data, run_out_path):
   ...
   # Plots before cut
   plot_distribution(galcen_data, run_out_path, 'r', 0, 25500, [6000, 25500])
   plot_distribution(galcen_data, run_out_path, 'z', -2000, 2000, [-1000, 1000])
...
def get_galcen_data(r_0):
   ...
   # Update solar vector
   v_sun[1][0] = 247.3*(r_0/8178)
   v_sun[2][0] = 7.8*(r_0/8178)
...
if __name__ == '__main__':
   ...
   print('Importing DR3...')
   dr3_path = '/scratch/local/sven/ou_icrs_sample.csv'
   ...
   fig2 = display_polar_histogram(galcen_data, run_out_path, r_limits=(0, 25500), norm_max=100, title = "Distribution of data on the Galactic plane")
