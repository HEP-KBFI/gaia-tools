...
galcen_data = galcen_data[(galcen_data.z < 5) & (galcen_data.z > -5)]
...
def log_prior(theta):
   ...
   trig_2 = (theta[-1] > 229) and (theta[-1]  < 234)
...
theta_0 = (-300,-190, -210, -275, -147, 230)
...
fn='sampler_unoptimized_6P_test_nsteps_{}_{}'.format(nsteps, start_datetime)
