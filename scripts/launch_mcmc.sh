...
python3 run_mcmc_asymmetric_Vc_Only.py --cut-range 0.1 --nwalkers 50 --nsteps 7000 --nbins 10 --disk-scale 3000.0 --vlos-dispersion-scale 16000.0
...
# python3 run_mcmc_asymmetric_Vc_Only.py --cut-range 0.3 --nwalkers 50 --nsteps 7000 --nbins 10 --disk-scale 3000.0 --vlos-dispersion-scale 24000.0
