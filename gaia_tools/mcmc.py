...
def run_sampler(theta_0 = None, 
    ...
    def log_likelihood(theta):
        ...
        bin_collection = data_analysis.get_collapsed_bins(galcen_data, BL_r = BL_r, BL_z = BL_z, N_bins = (10, 10), debug = debug)
    ...
    def log_prior(theta):
        ...
        if 0.0 < r < 12000.0 and -50.0 < z < 50.0 and 0.0 < u_sun < 100.0 and 0.0 < v_sun < 1000.0 and 0.0 < w_sun < 100.0:
            return 0.0
    ...
    if(multiprocess):
        with Pool(processes) as pool:
            ...
            print("Starting sampling. Walkers = {a}, Steps = {b}, CPU = {c}".format(a=nwalkers, b=steps, c=processes))
